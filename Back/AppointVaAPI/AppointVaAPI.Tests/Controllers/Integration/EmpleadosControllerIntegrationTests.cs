...
public class EmpleadosControllerIntegrationTests : IntegrationTestBase
{
    public EmpleadosControllerIntegrationTests(CustomWebApplicationFactory factory)
        : base(factory) { }
    ...
    public async Task Crear_ConEmpleado_Retorna403()
    {
        ...
        var body = new StringContent(
            """{"nombre":"Test Empleado","email":"emp@test.com"}""",
            Encoding.UTF8, "application/json");

        var response = await Client.PostAsync("/api/empleados", body);
