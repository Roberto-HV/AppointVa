  ...
  return (
    <div>
      ...
      <button
        ...
        className={`w-full mb-3 p-4 rounded-2xl border-2 flex items-center gap-4 transition-all text-left
          ${activoSinPreferencia ? "border-slate-700 bg-slate-700/5" : "border-slate-100 hover:border-slate-300 bg-white hover:shadow-sm"}`}
      >
        <div className={`w-11 h-11 rounded-xl flex items-center justify-center shrink-0 transition
          ${activoSinPreferencia ? "bg-slate-700/10" : "bg-slate-100"}`}>
          <svg className={`w-5 h-5 ${activoSinPreferencia ? "text-slate-700" : "text-slate-400"}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="flex-1 min-w-0">
          <p className={`text-sm font-semibold ${activoSinPreferencia ? "text-slate-700" : "text-slate-800"}`}>
            Sin preferencia
          </p>
          ...
          return (
            <button
              ...
              className={`p-4 rounded-2xl border-2 text-center transition-all
                ${activo ? "border-slate-700 bg-slate-700/5 shadow-sm" : "border-slate-100 hover:border-slate-300 bg-white hover:shadow-sm"}`}
            >
              ...
              <p className={`text-sm font-semibold ${activo ? "text-slate-700" : "text-slate-800"}`}>
                {emp.nombre}
              </p>
